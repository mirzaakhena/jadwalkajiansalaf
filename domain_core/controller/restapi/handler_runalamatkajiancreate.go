...
func (r *controller) runAlamatKajianCreateHandler() gin.HandlerFunc {

	type InportRequest = runalamatkajiancreate.InportRequest
	type InportResponse = runalamatkajiancreate.InportResponse
	...
	return func(c *gin.Context) {
		...
		jsonRes.AlamatKajianID = res.AlamatKajianID

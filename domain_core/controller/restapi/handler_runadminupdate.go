...
func (r *controller) runAdminUpdateHandler() gin.HandlerFunc {

	type InportRequest = runadminupdate.InportRequest
	type InportResponse = runadminupdate.InportResponse

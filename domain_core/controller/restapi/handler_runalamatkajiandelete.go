...
func (r *controller) runAlamatKajianDeleteHandler() gin.HandlerFunc {

	type InportRequest = runalamatkajiandelete.InportRequest
	type InportResponse = runalamatkajiandelete.InportResponse

...
func (r *controller) getAllAlamatKajianHandler() gin.HandlerFunc {

	type InportRequest = getallalamatkajian.InportRequest
	type InportResponse = getallalamatkajian.InportResponse

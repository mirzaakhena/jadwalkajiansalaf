...
func (r *controller) runKajianCreateHandler() gin.HandlerFunc {

	type InportRequest = runkajiancreate.InportRequest
	type InportResponse = runkajiancreate.InportResponse

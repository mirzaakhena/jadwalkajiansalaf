...
func (r *controller) runKategoriKajianUpdateHandler() gin.HandlerFunc {

	type InportRequest = runkategorikajianupdate.InportRequest
	type InportResponse = runkategorikajianupdate.InportResponse

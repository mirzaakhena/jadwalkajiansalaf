...
func (r *controller) runKategoriKajianDeleteHandler() gin.HandlerFunc {

	type InportRequest = runkategorikajiandelete.InportRequest
	type InportResponse = runkategorikajiandelete.InportResponse

	inport := gogen.GetInport[InportRequest, InportResponse](r.GetUsecase(InportRequest{}))

	type request struct {
		KategoriKajianID vo.KategoriKajianID `json:"kategori_kajian_id"`
	}

...
func (r *controller) runPenyelenggaraKajianDeleteHandler() gin.HandlerFunc {

	type InportRequest = runpenyelenggarakajiandelete.InportRequest
	type InportResponse = runpenyelenggarakajiandelete.InportResponse

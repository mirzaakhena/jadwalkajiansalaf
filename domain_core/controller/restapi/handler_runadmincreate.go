...
func (r *controller) runAdminCreateHandler() gin.HandlerFunc {

	type InportRequest = runadmincreate.InportRequest
	type InportResponse = runadmincreate.InportResponse
	...
	type response struct {
		AdminID vo.AdminID `json:"admin_id"`
	}

...
func (r *controller) getAllPemateriHandler() gin.HandlerFunc {

	type InportRequest = getallpemateri.InportRequest
	type InportResponse = getallpemateri.InportResponse

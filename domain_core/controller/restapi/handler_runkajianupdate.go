...
func (r *controller) runKajianUpdateHandler() gin.HandlerFunc {

	type InportRequest = runkajianupdate.InportRequest
	type InportResponse = runkajianupdate.InportResponse

	inport := gogen.GetInport[InportRequest, InportResponse](r.GetUsecase(InportRequest{}))

	type request struct {
		KajianID vo.KajianID `json:"kajian_id"`
	}

...
func (r *controller) getAllKategoriKajianHandler() gin.HandlerFunc {

	type InportRequest = getallkategorikajian.InportRequest
	type InportResponse = getallkategorikajian.InportResponse

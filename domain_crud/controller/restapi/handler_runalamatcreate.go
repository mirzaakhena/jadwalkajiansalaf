...
func (r *controller) runAlamatCreateHandler() gin.HandlerFunc {

	type InportRequest = runalamatcreate.InportRequest
	type InportResponse = runalamatcreate.InportResponse

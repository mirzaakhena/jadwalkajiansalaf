...
func (r *controller) runPenyelenggaraUpdateHandler() gin.HandlerFunc {

	type InportRequest = runpenyelenggaraupdate.InportRequest
	type InportResponse = runpenyelenggaraupdate.InportResponse

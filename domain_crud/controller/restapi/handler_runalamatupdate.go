...
func (r *controller) runAlamatUpdateHandler() gin.HandlerFunc {

	type InportRequest = runalamatupdate.InportRequest
	type InportResponse = runalamatupdate.InportResponse
	...
	return func(c *gin.Context) {
		...
		req.AlamatID = vo.LokasiID(c.Param("alamat_id"))

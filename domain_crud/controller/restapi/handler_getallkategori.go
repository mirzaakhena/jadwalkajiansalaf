...
func (r *controller) getAllKategoriHandler() gin.HandlerFunc {

	type InportRequest = getallkategori.InportRequest
	type InportResponse = getallkategori.InportResponse

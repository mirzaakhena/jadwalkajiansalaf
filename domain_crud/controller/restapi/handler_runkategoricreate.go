...
func (r *controller) runKategoriCreateHandler() gin.HandlerFunc {

	type InportRequest = runkategoricreate.InportRequest
	type InportResponse = runkategoricreate.InportResponse

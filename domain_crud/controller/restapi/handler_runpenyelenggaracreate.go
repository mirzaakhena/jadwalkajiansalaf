...
func (r *controller) runPenyelenggaraCreateHandler() gin.HandlerFunc {

	type InportRequest = runpenyelenggaracreate.InportRequest
	type InportResponse = runpenyelenggaracreate.InportResponse

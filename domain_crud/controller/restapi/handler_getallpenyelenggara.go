...
func (r *controller) getAllPenyelenggaraHandler() gin.HandlerFunc {

	type InportRequest = getallpenyelenggara.InportRequest
	type InportResponse = getallpenyelenggara.InportResponse

...
func (r *controller) runKategoriUpdateHandler() gin.HandlerFunc {

	type InportRequest = runkategoriupdate.InportRequest
	type InportResponse = runkategoriupdate.InportResponse

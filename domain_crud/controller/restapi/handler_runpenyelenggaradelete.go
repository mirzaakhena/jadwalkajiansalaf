...
func (r *controller) runPenyelenggaraDeleteHandler() gin.HandlerFunc {

	type InportRequest = runpenyelenggaradelete.InportRequest
	type InportResponse = runpenyelenggaradelete.InportResponse

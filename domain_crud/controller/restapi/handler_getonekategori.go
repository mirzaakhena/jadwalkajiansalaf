...
func (r *controller) getOneKategoriHandler() gin.HandlerFunc {

	type InportRequest = getonekategori.InportRequest
	type InportResponse = getonekategori.InportResponse
